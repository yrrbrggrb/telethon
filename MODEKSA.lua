...
serpent = dofile("./setup/serpent.lua") 
json = dofile("./setup/JSON.lua") 
JSON  = dofile("./setup/dkjson.lua")
...
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'Ahmadnnnnmm')..')'
...
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'Ahmadnnnnmm')..') '
status  = '\n تم ترقيته مطور في البوت'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• العضو> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Ahmadnnnnmm')..') \n •'..MODEKSA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/Ahmadnnnnmm)}\n•["..MODEKSA_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "•عذرا يا > {["..data.first_name_.."](T.ME/Ahmadnnnnmm)}\n• الملصق الذي ارسلته تم منعه من القروب \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@Ahmadnnnnmm','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
Text = [[
╭• [𝑵𝒊𝑮𝑮𝑨 𝑺𝑶𝑼𝑹𝑺𝑬](t.me/Ahmadnnnnmm) •╮
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'سورس صلاح حمدان' or text == 'اريد بوت تمبلر' or text == 'سورس صلاح حمدان' then
Text = [[
•- DEV @HK_RT مبرمج بوتات•
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
Text = [[
اهلا عزيزي
متوفر تنصيب بوتات ع سورس صلاح حمدان
احدث واسرع البوتات وضمان الثقه
للاستفسار راسل المطور @HK_RT
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
Text = [[
اهلا عزيزي
لايوجد اوامر في البوت مثل هذا
اكتب `الاوامر` وتحكم في الكيبورد بالاسفل
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == '@HK_RT' or text == '@Ahmadnnnnmm' or text == 'صلاح حمدان' then
Text = [[
@HK_RT هذا مطور سورس صلاح حمدان
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Ahmadnnnnmm')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'Ahmadnnnnmm')..') \n*•تم قفـل الدردشه*\n')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Ahmadnnnnmm')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'Ahmadnnnnmm')..') \n*تم قفـل الالعاب*\n')  
end,nil)   
...
local UserName = (b.username_ or "Ahmadnnnnmm")
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n• العضو > ['..result.title_..'](t.me/'..(text1[3] or 'Ahmadnnnnmm')..')'..'\n تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'صلاح حمدان').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'صلاح حمدان')
local MODEKSA_Msg = {
'هلا يا عمري .',
'بقولك انت تحبني ؟ وتصيحني بالشكل دا',
'ۿۧاا  .',
'اسمي '..Namebot..' متقولش بوت ɵ̷̥̥᷄ˬɵ̷̥̥᷅',
'بطل صياح وربنا اخرج من ام الروم دا',
'عيونه',
'نعم يحب.',
}
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'صلاح حمدان').." غادر" or text == 'بوت غادر' then  
...
Text = ' • عدد جهاتك > ['..Num..'](https://t.me/Ahmadnnnnmm) •'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [ᥰᎥᧁᧁꪖ - SoUrCe](https://t.me/Ahmadnnnnmm)
]]
...
send(msg.chat_id_,0,"•العضو : {["..data.first_name_.."](T.ME/Ahmadnnnnmm)}\n•["..MODEKSAAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
